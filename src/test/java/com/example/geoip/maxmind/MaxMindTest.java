package com.example.geoip.maxmind;
...
public class MaxMindTest {
    ...
    public void country() throws IOException, GeoIp2Exception {
        ClassPathResource classPathResource = new ClassPathResource("database/maxmind/GeoLite2-Country.mmdb");
...
//        DatabaseReader reader = new DatabaseReader.Builder(database).build();
    ...
    public void city() throws IOException, GeoIp2Exception {
        ClassPathResource classPathResource = new ClassPathResource("database/maxmind/GeoLite2-City.mmdb");
        // A File object pointing to your GeoIP2 or GeoLite2 database
        File database = classPathResource.getFile();
...
//        DatabaseReader reader = new DatabaseReader.Builder(database).build();
    ...
    public void asn() throws IOException, GeoIp2Exception {
        ClassPathResource classPathResource = new ClassPathResource("database/maxmind/GeoLite2-ASN.mmdb");
